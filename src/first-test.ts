...
import type { RuleList, RuleResult } from './types/rule-types'
...
export function getFirstTruthyResult<T extends TokenType>(tests: RuleList<T>, code: string, pos: number): RuleResult<T> | Void
export function getFirstTruthyResult<T extends TokenType>(tests: RuleList<T>, code: string, pos: number): RuleResult<T> | Void {
