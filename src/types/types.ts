...
export type CreateTokenGenerator<T extends TokenType, L extends TokenType> = (input: string, offset?: number) => TokenGenerator<T, L>
...
export type Lexer<T extends TokenType, L extends TokenType> = (input: string, offset?: number) => GetNextToken<T, L>
export type Tokenizer<T extends TokenType, L extends TokenType> = (input: string, offset?: number) => TokenListWithLastToken<T, L>
